...
\section{Honours}
\begin{CV}
  \item[2018-2019,2021] \href{hhttps://vectorinstitute.ai/2021/03/31/vector-welcomes-new-researchers-to-postgraduate-affiliate-program/}
...
\begin{itemize}
  ...
  \item Review for Conferences: \textit{INTERSPEECH} (2021),
    \textit{UIST} (2021), \textit{CUI} (2021), \textit{EMNLP} (2019),
    \textit{CHI - LBW} (2018)
\end{itemize}
