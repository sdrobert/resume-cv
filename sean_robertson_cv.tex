...
\section{Honours}
\begin{CV}
  \item[2018] \href{https://vectorinstitute.ai/2018/02/01/vector-institute-launches-inaugural-postgraduate-affiliate-program-2/}
...
\begin{CV}
  \item[Current] Topics: Speech recognition; deep learning; multi-scale
    ...
    Courses taken: Learning Discrete Latent Structure (A+); Numerical Methods
    for Optimization Problems (A+).
...
\begin{itemize}
  ...
  \item Minhas, U. F., Liu, R., Aboulnaga, A., Salem, K., Ng, J.,
    \textbf{Robertson, S.} (2012). \textit{Elastic scale-out for partition-based
    database systems}. IEEE 28th International Conference on
...
\begin{CV}
  ...
  \item[2014,2016,2017] Computational Linguistics - Teaching Assistant

    Pre- and post-assignment tutorials; assignment revisions; and marking.
...
\begin{CV}
  \item[2014-pres] Contracted work for Speax Inc.

    Speech recognition software; development; consultation.
\end{CV}

% \section{Languages}
% English (fluent), French (basic), and Japanese (conversational, spoken).
